...
def dijkstra(nodes, neighbors_list, start_node, end_node):
    ...
    while unvisited_nodes:
        ...
        for (V, D) in neighbors_list[current_node]:
            new_path = distance_from_start[current_node] + D
            if new_path < distance_from_start[V]:
                previous_node[V] = current_node
                distance_from_start[V] = new_path
