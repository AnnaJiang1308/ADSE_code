...
def main(place_name, start_name, end_name):
    ...
    # IMPORTANT: Enable the line below to see how the graph looks like
    ...
    # IMPORTANT: Enable the line below to see the result in your browser (shortest path)
    ...
    #  Start of your code  #
    ########################
    graph = speed.add_edge_speeds(graph)
    graph = speed.add_edge_travel_times(graph)
    travel_time = sum(ox.utils_graph.get_route_edge_attributes(graph, route, "travel_time"))
...
if __name__ == "__main__":
    ...
    time, dist = main(place_name_, stiglmaierplatz, profhuberplatz)
